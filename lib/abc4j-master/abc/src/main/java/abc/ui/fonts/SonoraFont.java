...
public class SonoraFont extends MusicalFontAbstract implements MusicalFont, Serializable {
	...
	throws MissingGlyphException, IllegalArgumentException {
		...
		//case Accidental.COMMA_SHARP_FIVE: return '\uF08F'; //K���k M�cennep Diyezi
		//case Accidental.COMMA_SHARP_EIGHT: return '\uF090'; //Buyuk M�cennep Diyezi
		//case Accidental.COMMA_FLAT_ONE: return '\uF091'; //Koma Bemol�
		//case Accidental.COMMA_FLAT_FOUR: return '\uF092'; //Bakiyye Bemol�
		//case Accidental.COMMA_FLAT_EIGHT: return '\uF093'; //Tanini Bemol�
