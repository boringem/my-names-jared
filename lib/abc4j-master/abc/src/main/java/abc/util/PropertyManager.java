...
public final class PropertyManager {
  ...
  private final static String DEFAULT_PROPERTIES_FILE   = "preferences" + File.separator + "default.properties";
  private final static String APP_PROPERTIES_FILE       = "preferences" + File.separator + "app.properties";
